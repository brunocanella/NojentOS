...
SOURCEFILES_QUOTED_IF_SPACED=main.c kernel/timers.c nojentOS.c kernel/dispatcher.c kernel/scheduler.c kernel/task.c kernel/memory.c kernel/linked_list.c kernel/semaphore.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.p1 ${OBJECTDIR}/kernel/timers.p1 ${OBJECTDIR}/nojentOS.p1 ${OBJECTDIR}/kernel/dispatcher.p1 ${OBJECTDIR}/kernel/scheduler.p1 ${OBJECTDIR}/kernel/task.p1 ${OBJECTDIR}/kernel/memory.p1 ${OBJECTDIR}/kernel/linked_list.p1 ${OBJECTDIR}/kernel/semaphore.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/main.p1.d ${OBJECTDIR}/kernel/timers.p1.d ${OBJECTDIR}/nojentOS.p1.d ${OBJECTDIR}/kernel/dispatcher.p1.d ${OBJECTDIR}/kernel/scheduler.p1.d ${OBJECTDIR}/kernel/task.p1.d ${OBJECTDIR}/kernel/memory.p1.d ${OBJECTDIR}/kernel/linked_list.p1.d ${OBJECTDIR}/kernel/semaphore.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.p1 ${OBJECTDIR}/kernel/timers.p1 ${OBJECTDIR}/nojentOS.p1 ${OBJECTDIR}/kernel/dispatcher.p1 ${OBJECTDIR}/kernel/scheduler.p1 ${OBJECTDIR}/kernel/task.p1 ${OBJECTDIR}/kernel/memory.p1 ${OBJECTDIR}/kernel/linked_list.p1 ${OBJECTDIR}/kernel/semaphore.p1

# Source Files
SOURCEFILES=main.c kernel/timers.c nojentOS.c kernel/dispatcher.c kernel/scheduler.c kernel/task.c kernel/memory.c kernel/linked_list.c kernel/semaphore.c
